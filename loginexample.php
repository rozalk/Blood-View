        ...
        ?>
            ...
            <label>Password:</label>
             <div class="password-container">
                ...
                <input type="checkbox" id="showPasswordCheckbox" label for="showPasswordCheckbox" class="show-password-label">Show password</label>
            ...
            <input type="submit" name="login" value="Login" id="logginn">
